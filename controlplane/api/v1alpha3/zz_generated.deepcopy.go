...
func (in *CCMSpec) DeepCopyInto(out *CCMSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CCMSpec.
func (in *CCMSpec) DeepCopy() *CCMSpec {
	if in == nil {
		return nil
	}
	out := new(CCMSpec)
...
func (in *OpenshiftAssistedControlPlaneConfigSpec) DeepCopyInto(out *OpenshiftAssistedControlPlaneConfigSpec) {
	*out = *in
	if in.InfraClusterRef != nil {
		in, out := &in.InfraClusterRef, &out.InfraClusterRef
	...
	if in.Network != nil {
		...
		*out = new(WorkloadClusterNetworkSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.APIVIPs != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkloadClusterNetworkSpec) DeepCopyInto(out *WorkloadClusterNetworkSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkloadClusterNetworkSpec.
func (in *WorkloadClusterNetworkSpec) DeepCopy() *WorkloadClusterNetworkSpec {
	if in == nil {
		return nil
	}
	out := new(WorkloadClusterNetworkSpec)
